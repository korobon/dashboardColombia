  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      <div class="modal-header">
        ...
        <h4 class="modal-title">Update User #<span id="idUser"></span></h4>
      </div>
      ...
      <div class="modal-footer">
        ...
        <a id="submitUpdate" class="btn btn-default default">Save</a>
      </div>
    </div><!-- /.modal-content -->
  </div><!-- /.modal-dialog -->
</div><!-- /.modal -->
